...
4. Once calculations are completed run "python 2_gaussian_error.py" in your terminal. This code will determine if any calculations produced the errors l103, l502 or l9999 and attempt to fix the error by generating
...
5. Once all calculations are completed and successful, run "python 3_orca_inp.py" in your terminal. This code will generate 
...
6. Run "python 4_cclib.py" in your terminal. This code will generate 
